...
BOOST_AUTO_TEST_CASE(testOutputStack)
{
	...
	BOOST_TEST((lua_istable(state.getL(), 6) != 0));
}
...
BOOST_AUTO_TEST_CASE(testInteger)
{
	...
	BOOST_TEST(remote.getStackTop() == 1);
	BOOST_TEST((lua_isinteger(remote.getL(), remote.getStackTop()) != 0));
...
BOOST_AUTO_TEST_CASE(testNumber)
{
	...
	BOOST_TEST((lua_isnumber(remote.getL(), remote.getStackTop()) != 0));
...
BOOST_AUTO_TEST_CASE(testString)
{
	...
	BOOST_TEST((lua_isstring(remote.getL(), remote.getStackTop()) != 0));
...
BOOST_AUTO_TEST_CASE(testTable)
{
	...
	BOOST_TEST((lua_istable(remote.getL(), local.getStackTop()) != 0));
